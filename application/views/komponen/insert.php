...
<div class="row">
  ...
  <div class="col-md-12">
    <form action="<?php echo site_url('komponen/insert/'.$perangkat->id);?>" method="post">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="type" name="spec" placeholder="Spec *" value="<?php echo set_value('spec'); ?>">
      </div>
      <div class="form-group">
